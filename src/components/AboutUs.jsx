  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-content">
        ...
        a healthier and more sustainable lifestyle. From air-purifying plants
        to aromatic fragrant ones, we have something for every plant enthusiast.
      </p>
      ...
      <p className="about-us-content">
        ...
        step of the way. Feel free to explore our collection, ask questions,
